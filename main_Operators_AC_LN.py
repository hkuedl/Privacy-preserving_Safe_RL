...
from Environment.Env_NewObs_Oneday_PSO_HSO_GSO_AC_LN import Multi_Energy_Env
from Simulation.Algorithm_day_OneOp_PSO_HSO_GSO_Privacy_AC_LN import BatchRLAlgorithm               #一天一循环
...
if __name__ == "__main__":
    ...
    variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=4096,
            result_dir='workspaces/Multi_energy/Results/R',
        ),
        trainer_kwargs=dict(
            discount=0.995,
            soft_target_tau=6e-3,
