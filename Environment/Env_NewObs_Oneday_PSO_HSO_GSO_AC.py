...
class Multi_Energy_Env(gym.Env):
    ...
    def __init__(self):
        ...
        self.dg_q_power_max = 40                       # max reactive power out of diesel generator
        self.gt_q_power_max = 40                       # max reactive power out of gas turbine
    ...
    def step(self, epoch, action, trade, env_step, max_env_step):
        ...
        output_dg_q = action[2] * self.dg_q_power_max
        output_gt_q = action[3] * self.gt_q_power_max        
